...
// import CocaCola2L from './imgProdutos/CocaCola2L.png';
// import FantaLaranja2L from './imgProdutos/FantaLaranja2L.png';
// import GuaranaAntartica from './imgProdutos/GuaranaAntartica.png';
// import Sprite2L from './imgProdutos/Sprite2L.png';
...
const products = [
  ...
  //   description: "Coca-Cola em uma garrafa de 2 litros, perfeita para compartilhar com amigos e família.",
  //   image: CocaCola2L,
  //   price: "R$11,80",
  //   category: "Bebidas"
  // },
  ...
  //   description: "O delicioso e vibrante sabor de laranja de Fanta em uma garrafa de 2 litros, ideal para qualquer ocasião.",
  //   image: FantaLaranja2L,
  //   price: "R$8,90",
  //   category: "Bebidas"
  // },
  // {
  //   product: "Guaraná Antarctica",
  //   description: "O autêntico sabor brasileiro de Guaraná em uma garrafa de 2 litros, ideal para acompanhar suas refeições favoritas.",
  ...
  // {
  //   product: "Sprite 2L",
  //   description: "O refrescante e leve sabor de limão-lima de Sprite em uma garrafa de 2 litros, excelente para matar a sede.",
  //   image: Sprite2L,
  //   price: "R$43,90",
  //  
