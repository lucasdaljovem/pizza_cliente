    ...
    <footer className="footer text-center text-lg-start bg-body-tertiary text-muted">
      ...
      {/* <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        {/* <div className="me-5 d-none d-lg-block">
          <span>Siga-nos nas Redes Sociais. Fique por dentro das nossas novidades,<br /> promoções e eventos especiais</span>
        </div> */}
        {/* Left */}
          ...
          <div className="row mt-3">
            ...
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <h6 className="text-uppercase fw-bold mb-4">
                <i className="fas fa-gem me-3"></i>Sapore Di Pizza
              </h6>
              <p>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p><i className="fas fa-home me-3"></i>Avenida San Giovanni, 2345, Florianópolis-SC, 88040-222</p>
              <p>
                <i className="fas fa-envelope me-3"></i>
                contato@saporedipizza.com.br
              </p>
